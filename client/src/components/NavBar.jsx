...
import { setcart, setisActiveMenu , setchat, setnotification, setprofile } from '../redux/SideBar/sideBarSlice';
...
const NavBar = () => {
  const isActiveMenu = useSelector(
    (state) => state.sideBar.isActiveMenu
  );
  const { cart, chat, notification, profile } = useSelector(state => state.sideBar);
