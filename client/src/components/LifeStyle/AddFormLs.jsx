    ...
    <div className="w-400 bg-slate-200">
      ...
      <form className="max-w-lg mx-auto " onSubmit={handleSubmit(onSubmit)}>
        <div className="relative z-0 w-full mb-5 group">
          ...
          <span className="bg-blue-100 text-blue-800 text-xs font-semibold px-2 py-0.5 rounded dark:bg-blue-200 dark:text-blue-800 ms-2">{errors.LifeStyle_name?.message}</span>
        </div>
        <div className="relative z-0 w-full mb-5 group">
          <input
            type="text"
          ...
          <span className="bg-blue-100 text-blue-800 text-xs font-semibold px-2 py-0.5 rounded dark:bg-blue-200 dark:text-blue-800 ms-2">{errors.LifeStyle_Type?.message}</span>
        </div>
        <div className="relative z-0 w-full mb-5 group">
          <input
            type="textarea"
          ...
          <span className="bg-blue-100 text-blue-800 text-xs font-semibold px-2 py-0.5 rounded dark:bg-blue-200 dark:text-blue-800 ms-2">{errors.LifeStyle_Story?.message}</span>
        </div>
        ...
        <div className="relative z-0 w-full mb-5 group">
          ...
          <span className="bg-blue-100 text-blue-800 text-xs font-semibold px-2 py-0.5 rounded dark:bg-blue-200 dark:text-blue-800 ms-2">{errors.LifeStyle_imgurl?.message}</span>
        </div>
        ...
        />
        <span className="bg-blue-100 text-blue-800 text-xs font-semibold px-2 py-0.5 rounded dark:bg-blue-200 dark:text-blue-800 ms-2">{errors.LifeStyle_image?.message}</span>
        <button
          type="submit"
