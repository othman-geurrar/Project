...
export default function Accessorie() {
  return (
    <>
      <div className="text-center text-[30px] md:text-[46px] mb-3 pt-6 font-followus text-[#484848]">
        Women Accessorie{" "}
      </div>
      <section className="grid md:grid-cols-2 gap-6 lg:gap-24 items-center max-w-6xl  mx-auto py-6 md:py-8">
      ...
      <section className="grid md:grid-cols-2 gap-6 lg:gap-24 items-center max-w-6xl  mx-auto py-6 md:py-12 lg:py-14">
        <div className="grid gap-6 md:gap-8">
          <div className="grid md:grid-cols-2 gap-6 md:gap-8">
            <ProductCard
