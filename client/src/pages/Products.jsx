...
import { getproducts, deleteproduct } from "../redux/Products/productsSlice";
import { FaBoxesStacked } from "react-icons/fa6";

import Header from "../components/Header";

function Products() {
  const { error, isLoadingproducts, products } = useSelector(
                            ...
                            <>
                              <tr className="bg-white hover:bg-gray-50 text-center">
                                ...
                                <td className=" whitespace-nowrap align-center text-center">
                                  {item.inStock && (
                                    <>
                                      <span className="bg-green-100 text-green-800  text-xs font-medium me-2 px-6 py-1 rounded-full dark:bg-green-900 dark:text-green-300">
                                        in Stock
                                      </span>
                                    </>
                                  )}
