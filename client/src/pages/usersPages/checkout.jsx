...
function CheckoutPage() {
    ...
    const calculateSubtotal = () => {
        return products?.reduce((total, item) => total + item.newPrice * item.quantity, 0).toFixed(2);
    };
    ...
    const onToken = async (token) => {
        ...
        try {
            ...
            // Add orders
            await addOrder({ userId: 6954, products: products }).unwrap();
            navigate("/");
        } catch (error) {
                ...
                <div className="px-4 pt-8">
                    ...
                    <div className="grid gap-6">
                        {products?.map((product) => (
                            <div key={product.productId} className="grid grid-cols-[80px_1fr_auto] items-center gap-4">
                                <img
                                    alt="Product Image"
  ...
  />
                        ...
                        <div className="border rounded-lg p-4 flex items-center justify-between">
                            ...
                            <StripeCheckout
                                name="Lama Shop"
                                image="https://yourimageurl.com/logo.png"
                                billingAddress
                                shippingAddress
