...
function ProductDetail() {
  ...
  return (
    <>
      <NavBaar />
      <div
        className=" grid my-16 gap-6 lg:gap-12 items-start max-w-6xl px-4 mx-auto py-6"
      ...
      >
        ...
        <div className="grid gap-4  items-start">
          ...
          <form className="grid gap-3" onSubmit={handleSubmit}>
                ...
                >
                  <Radio
                    ...
                    checkedIcon={
                      <Done
                        fontSize="xl2"
                        sx={{ color: isColorDark(color) ? "white" : "black" }}
                      />
                    }
                    value={color}
                    slotProps={{
            ...
            <button
              type="submit"
              className=" mr-20 py-2 bg-blue-600 text-white rounded-lg"
              aria-live="assertive"
            >
              Add to cart
            </button>
