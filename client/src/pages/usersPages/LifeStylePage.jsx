...
// import metalica from "./metalica.png";
// import hiphop from "./hiphop.png";
// import hippy from "./hippy.png";
// import riders from "./riders.png";
  ...
  return (
    <>
      <div className="">
        ...
        {/* Under_HeroSection */}
        {/* <div className="text-center  text-[46px]  font-followus text-[#484848]">
          Our Lifestyles
        </div>
        ...
        <section className="pt-[50px] ">
          ...
          <div className="hidden md:block">
            ...
            <div
              className=" md:flex justify-center mb-[50px] md:gap-[50px] gap-[15px] md:py-0  md:w-[70%] md:mx-auto"
              // style={{ marginBottom: "50px" }}
            >
              <div
                className="md:rounded-xl rounded-md h-[360px] w-[240px]   transition duration-500 hover:scale-110  bg-cover bg-center bg-[url('https://i.pinimg.com/564x/16/cc/c7/16ccc763b0a8800cbcd4003a9af23159.jpg')]"
                style={{ boxShadow: "-7px 6px 13px 0px #000" }}
              >
                {/* description */}
              ...
              <div
                className="rounded-xl h-[360px] w-[240px]    transition duration-500 hover:scale-110  bg-cover bg-center bg-[url('https://i.pinimg.com/originals/84/89/c5/8489c5f4cdb27edd1cfa6aded008f639.jpg')]"
                style={{ boxShadow: "-7px 6px 13px 0px #000" }}
              >
              ...
              <div
                className="rounded-xl h-[360px] w-[240px]    transition duration-500 hover:scale-110  bg-cover bg-center bg-[url('https://img.freepik.com/photos-premium/fete-hippie_808092-6647.jpg?w=360')]"
                style={{ boxShadow: "-7px 6px 13px 0px #000" }}
              >
                <div className="h-full w-full  rounded-xl  transition duration-500 backdrop-brightness-[0.6] flex flex-col pt-[50px] font-lifestylename text-white ">
              ...
              <div
                className="rounded-xl h-[360px] w-[240px]    transition duration-500 hover:scale-110  bg-cover bg-top bg-[url('https://i.pinimg.com/736x/0d/d3/f4/0dd3f42139c0a48c900fc8b9f87fbafa.jpg')]"
                style={{ boxShadow: "-7px 6px 13px 0px #000" }}
              >
                <div className="h-full w-full  rounded-xl  transition duration-500 backdrop-brightness-[0.6] flex flex-col pt-[50px] font-lifestylename text-white ">
          ...
          >
            <SwiperSlide
              ...
              style={{ boxShadow: "rgb(0 0 0 / 42%) -19px 7px 20px 0px" }}
            >
              <div className="h-full w-full  rounded-xl  transition duration-500 md:justify-start justify-center backdrop-brightness-[0.6] flex flex-col md:pt-[50px]  font-lifestylename text-white ">
                <div className=" text-center text-[40px]">Metal</div>
                <div className="px-[10px] md:text-[20px] text-center ">
