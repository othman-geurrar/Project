...
import { Deletebutton } from "../../components/AdminBackLock/Admins/deleteAdmin";
...
function Admins() {
  ...
  const indexOfFirstorder = indexOfLastorder - adminsPerPage;
  const pageNumber = [];
  const currentadmins = admins.slice(indexOfFirstorder, indexOfLastorder);
  for (let i = 1; i <= Math.ceil(admins.length / adminsPerPage); i++) {
    pageNumber.push(i);
  }
